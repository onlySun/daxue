    ...
    <tr>
        ...
        <td valign="top" width="100%" height="100%">
            <div style="margin-left: 150px;">
                ...
                <form method="post" action="enProjectAddAct">
                    <br /><br />
                    标题：*
                    <input name="title" type="text" value="<?php echo !empty($enProject->title) ? $enProject->title : ''?>">
                    <br /><br />
                    内容：*
                    <textarea name="content"><?php echo !empty($enProject->content) ? $enProject->content : ''?></textarea>
                    <input type="hidden" value="<?php echo !empty($enProject->id) ? $enProject->id : ''?>" name="id">
