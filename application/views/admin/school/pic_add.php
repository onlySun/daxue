    ...
    <tr>
        ...
        <td valign="top" width="100%" height="100%">
            <div style="margin-left: 150px;">
                ...
                <form enctype="multipart/form-data" method="post" name="upform" action="picAddAct">
                    <br /><br />
                    标题：*
                    <input type="text" value="<?php echo isset($picInfo->title) && !empty($picInfo->title) ? $picInfo->title : ''?>" name="title">
                    <br /><br />
                    图片类型：
                    ...
                    <br /><br />
                    图片：*
                    <input type="text" value="<?php echo isset($picInfo->url) && !empty($picInfo->url) ? $picInfo->url : ''?>">
