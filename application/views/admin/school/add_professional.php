    ...
    <tr>
        ...
        <td valign="top" width="100%" height="100%">
            <div style="margin-left: 150px;">
                ...
                <form method="post" action="professionalAddAct">
                    <br /><br />
                    专业标准名称：*
                    <select name="professional_id" style="width: 150px;">
                        <?php foreach($professionalArr as $val):?>
                        <option value="<?php echo $val->id.'_'.$val->name;?>" <?php (isset($unProfessional->professional_id) && $unProfessional->professional_id == $val->id) ? "selected" : '';?>><?php echo $val->name;?></option>
                        <?php endforeach;?>
                    </select>
                    <br /><br />
                    专业名称：
                    <input name="profession_name" type="text" value="<?php echo !empty($unProfessional->profession_name) ? $unProfessional->profession_name : '输入文本...'?>">
                    <br /><br />
                    专业简介：*
                    <textarea name="profession_description"><?php echo !empty($unProfessional->profession_description) ? $unProfessional->profession_description : '输入文本...'?></textarea>
                    <input type="hidden" value="<?php echo !empty($unProfessional->id) ? $unProfessional->id : ''?>" name="id">
