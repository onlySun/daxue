    ...
    <tr>
        ...
        <td valign="top" width="100%" height="100%">
            <div style="margin-left: 150px;">
                ...
                <?php echo !empty($university[0]->name) ? $university[0]->name : '';?>专业列表
                <br /><br />
                <div class="list" style="width: 80%">
                    <table style="border: 1px solid black; border-collapse:collapse;">
                        ...
                        <?php foreach($professionalList as $val):?>
                        <tr>
                            <td><?php echo $val->id;?></td>
                            <td><?php echo $val->profession_name;?></td>
                            <td>
                                <a href="/index.php/admin/university/delProfessional?name=<?php echo $university[0]->name?>&id=<?php echo $val->id?>">删除</a>
                                <a href="/index.php/admin/university/professionalAdd?name=<?php echo $university[0]->name?>&type=up&id=<?php echo $val->id?>">修改</a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </table>
                    ...
                    <div style="margin-top: 20px;margin-left: 100px;">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td><span><a href="/index.php/admin/university/professionalList?name=<?php echo $university[0]->name;?>&page=<?php echo $i;?>"><?php echo $i;?></a></span></td>
                                <?php endfor;?>
                            </tr>
                        </table>
                    </div>
