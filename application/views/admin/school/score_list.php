        ...
        <td valign="top" width="100%" height="100%">
            <div style="margin-left: 150px;">
                ...
                <div style="clear: both">
                    <div style="float: left">专业选择：</div>
                    <div style="float: left">
                        <a href="<?php echo $uri.$is_query.'professional_id=';?>">全部</a>
                        <?php foreach ($professionalArr as $val):?>
                        <span><a href="<?php echo $uri.$is_query.'professional_id='.$val->id;?>"><?php echo $val->name;?></a></span>
                        <?php endforeach;?>
                    </div>
                </div>
                <br />
                ...
                <div class="list">
                    <table style="border: 1px solid black; border-collapse:collapse;">
                        ...
                        <?php foreach($professionalScores as $val):?>
                        <tr>
                            <td><?php echo $val->id;?></td>
                            <td>
                                <?php foreach ($professionalArr as $value):?>
                                <?php if ($value->id == $val->professional_id):?>
                                <?php echo $value->name;?>
                                <?php endif;?>
                                <?php endforeach;?>
                            </td>
                            ...
                            <td>
                                <a href="/index.php/admin/university/delProfessionalScore?name=<?php echo $university[0]->name?>&id=<?php echo $val->id?>">删除</a>
                                <a href="/index.php/admin/university/scoreAdd?name=<?php echo $university[0]->name?>&type=up&id=<?php echo $val->id?>">修改</a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </table>
                ...
                <div style="margin-top: 20px;margin-left: 100px;">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td><span><a href="/index.php/admin/university/scoreList?page=<?php echo $i;?>"><?php echo $i;?></a></span></td>
                            <?php endfor;?>
                        </tr>
                    </table>
                </div>
