        ...
        <div style="margin-left: 150px;">
            ...
            <div class="list">
                ...
                <select name="type" size="4" style="width: 200px;">
                    <option>全部</option>
                    <option value="0" <?php echo isset($picInfo->type) && $picInfo->type == 0 ? "selected" : '';?>>学校图片</option>
                    <option value="1" <?php echo isset($picInfo->type) && $picInfo->type == 1 ? "selected" : '';?>>宿舍图片</option>
                    <option value="2" <?php echo isset($picInfo->type) && $picInfo->type == 2 ? "selected" : '';?>>食堂饭菜</option>
                </select>
                <br /><br />
                校园风光管理
                <br /><br />
                <div>
                    ...
                    <div class="pic">
                        <?php $folder = str_replace( '\\' , '/' , realpath(dirname(__FILE__).'/../../../views/images/'));?>
                        <?php $folder = str_replace('/', '\\', $folder);?>
                        <img src="<?php echo $folder.'\\'.$pic->url;?>"><br/><br/>
                        <span><?php echo $pic->title;?></span><br/><br/>
                        <div>
                            <span><a href="/index.php/admin/university/picAdd?type=up&name=<?php echo $university[0]->name?>&id=<?php echo $pic->id?>">修改</a></span>
                            <span><a href="/index.php/admin/university/delPic?name=<?php echo $university[0]->name?>&id=<?php echo $pic->id?>">删除</a></span>
                        </div>
                    </div>
                    <?php endforeach;?>
                </div>
