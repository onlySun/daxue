...
class ProfessionalModel extends CI_Model
{
    ...
    function insert_entry($insertRows)
    {
        ...
        $res = $this->db->insert('professional', $this);
        return $res;
    }
    ...
    function update_entry($updateRows)
    {
        ...
        $res = $this->db->update('professional', $this, array('id' => $updateRows['id']));
        return $res;
    }
    ...
    function getData($field = '*', $where, $offset = 0, $count = 20)
    {
        ...
        $query = $this->db->get('professional', $count, $offset);
        return $query->result();
    }
    ...
    function getCount()
    {
        return $this->db->count_all('professional');
    }
}